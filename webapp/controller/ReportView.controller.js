sap.ui.define([
    ...
    function (Controller, ResourceModel, ChartFormatter, Format, MessageToast, Filter, FilterOperator, JSONModel) {
        ...
        return Controller.extend("ns.zpmreportapp.controller.ReportView", {
            onInit: function () {
            ...
            onBtnFilter: function () {
                ...
                if (startDate && endDate) {
                  filter = new Filter("Fecha", FilterOperator.BT, startDate, endDate);
                } else if (startDate) {
                  filter = new Filter("Fecha", FilterOperator.EQ, startDate);
                } else if (endDate) {
                  filter = new Filter("Fecha", FilterOperator.EQ, endDate);
                }
            ...
            ConsultaDatosGrafica: function (aFilter) {
                const i18nModel = new ResourceModel({
                    bundleName: "ns.zpmreportapp.i18n.i18n"
                });
