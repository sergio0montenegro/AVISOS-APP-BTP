sap.ui.define([
    ...
    function (Controller, JSONModel, MessageToast) {
        ...
        const NAVIGATION_PROP = "/NavCatalogToCost";
        return Controller.extend("ns.zpmreportapp.controller.Detail", { 
            onInit: function () {
            ...
            _onRouteMatched: async function (oEvent) {
                ...
                oView = this.getView();
                var path = "/ZPM_Entity_CatalogoSet('" + oArgs.id.toString() + "')" + NAVIGATION_PROP;
