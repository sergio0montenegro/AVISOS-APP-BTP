		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nszpmreportapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nszpmreportapp-display": {
								"semanticObject": "nszpmreportapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.zpmreportapp",
									"url": sap.ui.require.toUrl("ns/zpmreportapp")
								}
							}
						}
					}
